    ...
    <div className="p-4 md:p-6 space-y-6 bg-gray-100 h-full">
      ...
      <div className="relative bg-gradient-to-r from-slate-900 to-slate-600 text-white rounded-lg shadow-xl overflow-hidden">
        ...
        <div className="relative z-10 p-6">
          {" "}
          {/* Konten header harus memiliki z-index lebih tinggi */}
          <h1 className="text-2xl md:text-3xl font-bold">Greetings Sir.</h1>
          <p className="mt-2 opacity-90">
            Welcome to HyperDash, this is a simple dashboard template built with
              ...
              {recentOrders.map((order) => (
                ...
                >
                  ...
                  <td className="px-4 sm:px-6 py-4 whitespace-nowrap text-sm">
                    <span
                      className={`px-2.5 py-0.5 inline-flex text-xs leading-5 font-semibold rounded-full bg-${order.statusColor}-100 text-${order.statusColor}-800`}
                    >
                      {order.status}
                    </span>
                  </td>
