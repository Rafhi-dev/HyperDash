...
const LoginForm = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[url(/pexels.jpg)] bg-cover backdrop-blur-lg ">
      <div className="bg-white p-8 rounded-lg shadow-md w-full max-w-sm">
        <div className="flex justify-center mb-6">
          <img src="/react.svg" alt="Logo Aplikasi" className="h-10" />{" "}
          {/* Sesuaikan path dan class sesuai kebutuhan */}
        </div>
        {error && (
          <div
